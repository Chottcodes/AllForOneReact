 ...
 const ResetClick = () => {
  ...
  return (
    ...
    >
      ...
      <Link className="bg-black bg-opacity-65 flex justify-center outline outline-white rounded-2xl h-[100%] w-[100%] lg:text-3xl lg:w-[80%] lg:h-[90%] text-white hover:outline-white hover:bg-black " to="/"><button
        className=""
      id="homeBTN"
        >
        Home
