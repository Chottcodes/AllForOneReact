...
const GreaterThan = () => {
    useEffect(() => {
        document.body.style.backgroundImage = "url('/src/assets/GreenPlanet.jpg')";
    ...
    >
      <h1 className="text-center" id="outputBox">
        Please enter two number and I will tell you which is greater.
      </h1>
    </div>
   
    <div
      className="bg-black bg-opacity-70 w-[80%] h-24 lg:w-[40%] lg:h-[20%] m-auto rounded-2xl flex justify-center"
    >
      <input
        type="text"
    ...
    <div
      className="bg-black bg-opacity-70 w-[80%] h-24 lg:w-[40%] lg:h-[20%] m-auto my-5 rounded-2xl flex justify-center"
    >
      <input
        type="text"
    ...
    <div
      className="buttonContainer bg-opacity-70 text-3xl w-[40%] h-56 flex flex-col gap-5 lg:h-20 lg:w-[50%] lg:gap-5 lg:items-center lg:flex-row lg:my-14 m-auto my-10 rounded-2xl lg:justify-evenly"
    >
      <button
