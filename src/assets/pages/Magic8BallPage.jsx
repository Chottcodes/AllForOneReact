...
const Magic8Ball = () => {
    ...
    return (
        <>
        <div
      className="prompt-container bg-black flex justify-center lg:my-24 items-center text-white text-2xl font-sans bg-opacity-70 h-[15%] w-[70%] lg:w-[35%] m-auto mt-20 my-6 rounded-3xl outline outline-white outline-1"
    >
      <h1 id="outputBox">Ask me a question</h1>
    </div>
    <div
      className="bg-opacity-70 h-[15%] w-[70%] m-auto my-7 rounded-3xl flex justify-center"
    >
      <input
        type="text"
    ...
    <div
      className="buttons h-[40%] w-[50%] gap-5 m-auto flex flex-col lg:flex-row lg:items-center"
    >
      <button
      ...
      <Link className="bg-black flex items-center justify-center bg-opacity-70 text-2xl text-white rounded-2xl h-[30%] w-[100%] m-auto outline outline-white outline-2 hover:bg-black lg:w-[30%]" to="/"><button
        className=""
      id="homeBTN"
        >
        Home
