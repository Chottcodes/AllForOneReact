...
const ReverseNumber = () => {
        ...
        useEffect(() => {
                document.body.style.backgroundImage = "url('/src/assets/Planets.jpg')";
                document.body.className ="h-screen fadeIn bg-cover overflow-hidden bg-center bg-no-repeat";
              }, []);
    return (
        <>
         <div
      className="w-[80%] h-[20%] lg:w-[50%] lg:mt-[10%] text-2xl text-center bg-black m-auto rounded-3xl outline font-sans text-white flex justify-center items-center outline-white outline-1 my-9 bg-opacity-70"
    >
      <h1 id="outputBox">Enter a number for me to reverse</h1>
    </div>
    <div
