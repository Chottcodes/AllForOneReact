...
const ReverseWord = () => {
  ...
  useEffect(() => {
    document.body.style.backgroundImage = "url('/assets/Eartth.jpg')";
  ...
  return (
    ...
    <div className="h-[100%] pt-4">
      <div className="w-[80%] h-[20%] lg:w-[50%] bg-black text-2xl m-auto rounded-3xl lg:mt-[10%] outline font-sans text-white flex justify-center items-center outline-white outline-1 my-9 bg-opacity-70">
        <h1 id="outputText" className="text-center">
          {ApiText}
        </h1>
      </div>
      ...
      <div className="buttonContainer bg-opacity-70 w-[60%] h-56 text-3xl flex flex-col gap-5 lg:h-20 lg:w-[50%] lg:gap-12 lg:items-center lg:flex-row lg:my-14 m-auto my-7 rounded-2xl lg:justify-evenly">
        ...
        <Link
          className="bg-black bg-opacity-65 flex justify-center items-center outline outline-white rounded-2xl h-[100%] w-[100%] lg:text-3xl lg:w-[50%] lg:h-[90%] text-white hover:outline-white hover:bg-black"
          to="/"
        >
